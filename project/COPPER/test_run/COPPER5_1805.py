...
configuration = pd.read_excel (r'COPPER_configuration_1805.xlsx',header=0)
...
if SMR_CCS:
    gendata = pd.read_excel (r'Generation_type_data_SMR_CCS_1805.xlsx',header=0 )
else:    
...
folder_name= str(1805) + '_outputs'+'_ct'+str(ctax)+'_rd'+str(len(rundays))+'_pds'+str(len(pds))
