...
configuration = pd.read_excel (r'COPPER_configuration_141.xlsx',header=0)
...
if SMR_CCS:
    gendata = pd.read_excel (r'Generation_type_data_SMR_CCS_141.xlsx',header=0 )
else:
    gendata = pd.read_excel (r'Generation_type_data_141.xlsx',header=0 )
...
demand_growth = pd.read_csv(r'annual_growth_141.csv',header=0,index_col=0)
...
folder_name=str(141) + '_outputs'+'_ct'+str(ctax)+'_rd'+str(len(rundays))+'_pds'+str(len(pds))
