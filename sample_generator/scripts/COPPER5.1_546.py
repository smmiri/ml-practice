...
configuration = pd.read_excel (r'COPPER_configuration_546.xlsx',header=0)
...
if SMR_CCS:
    gendata = pd.read_excel (r'Generation_type_data_SMR_CCS_546.xlsx',header=0 )
else:
    gendata = pd.read_excel (r'Generation_type_data_546.xlsx',header=0 )
...
demand_growth = pd.read_csv(r'annual_growth_546.csv',header=0,index_col=0)
...
folder_name=str(546) + '_outputs'+'_ct'+str(ctax)+'_rd'+str(len(rundays))+'_pds'+str(len(pds))
