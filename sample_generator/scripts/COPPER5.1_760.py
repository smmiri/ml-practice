...
configuration = pd.read_excel (r'COPPER_configuration_760.xlsx',header=0)
...
if SMR_CCS:
    gendata = pd.read_excel (r'Generation_type_data_SMR_CCS_760.xlsx',header=0 )
else:
    gendata = pd.read_excel (r'Generation_type_data_760.xlsx',header=0 )
...
demand_growth = pd.read_csv(r'annual_growth_760.csv',header=0,index_col=0)
...
folder_name=str(760) + '_outputs'+'_ct'+str(ctax)+'_rd'+str(len(rundays))+'_pds'+str(len(pds))
