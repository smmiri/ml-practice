...
cwd = '/scratch/smmiri/ctax_cap_popgrowth_09052022/inputs/'
...
configuration = pd.read_excel (r'COPPER_configuration_303.xlsx',header=0)
...
if SMR_CCS:
    gendata = pd.read_excel (r'Generation_type_data_SMR_CCS_303.xlsx',header=0 )
else:
    gendata = pd.read_excel (r'Generation_type_data_303.xlsx',header=0 )
...
demand_growth = pd.read_csv(r'annual_growth_303.csv',header=0,index_col=0)
...
folder_name=str(303) + '_outputs'+'_ct'+str(ctax)+'_rd'+str(len(rundays))+'_pds'+str(len(pds))
...
cwd = '/scratch/smmiri/ctax_cap_popgrowth_09052022/outputs/'
os.makedirs(cwd, exist_ok=True)
os.chdir(cwd)
