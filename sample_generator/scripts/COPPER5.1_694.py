...
configuration = pd.read_excel (r'COPPER_configuration_694.xlsx',header=0)
...
if SMR_CCS:
    gendata = pd.read_excel (r'Generation_type_data_SMR_CCS_694.xlsx',header=0 )
else:
    gendata = pd.read_excel (r'Generation_type_data_694.xlsx',header=0 )
...
demand_growth = pd.read_csv(r'annual_growth_694.csv',header=0,index_col=0)
...
folder_name=str(694) + '_outputs'+'_ct'+str(ctax)+'_rd'+str(len(rundays))+'_pds'+str(len(pds))
