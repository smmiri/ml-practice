...
configuration = pd.read_excel (r'COPPER_configuration_403.xlsx',header=0)
...
if SMR_CCS:
    gendata = pd.read_excel (r'Generation_type_data_SMR_CCS_403.xlsx',header=0 )
else:
    gendata = pd.read_excel (r'Generation_type_data_403.xlsx',header=0 )
...
demand_growth = pd.read_csv(r'annual_growth_403.csv',header=0,index_col=0)
...
folder_name=str(403) + '_outputs'+'_ct'+str(ctax)+'_rd'+str(len(rundays))+'_pds'+str(len(pds))
